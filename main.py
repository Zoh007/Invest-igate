...
df['Leisure'] = (df['Rent (USD)'] + df['Groceries (USD)']) / df[['Rent (USD)', 'Groceries (USD)', 'Eating Out (USD)', 'Entertainment (USD)',
...
X = df[['Age', 'Income (USD)', 'Rent (USD)', 'Groceries (USD)', 'Eating Out (USD)', 'Income_on_Rent', 'Savings', 'Leisure']]  # Add more features
y = df['Category']
